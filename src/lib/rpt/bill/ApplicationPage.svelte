...
<div class="inline-flex m-auto">
  <button alt="Queueing System" class="m-auto h-20 text-center bg-white bg-opacity-25 w-64 rounded-lg shadow-xl pt-1 mr-10 border-slate-400 flex border" on:click={openModal}>
